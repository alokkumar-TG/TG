...
public class TC018_Verify_the_pay_code_combinations_if_Holiday_Overtime_stack_overlaps_with_Shift_1_window_FTH_PT1_1731C_W_H_OT1040_PR {

	@Test(retryAnalyzer = RetryFailedTestCases.class)
	public void TC018_Verify_the_pay_code_combinations_if_Holiday_Overtime_stack_overlaps_with_Shift_1_window_FTH_PT1_1731C_W_H_OT1040_PR() {
		tg.openBrowser();
			...
			if (tg.performAssert(var_Process_Payrule, ComparisonType.EQUAL_TO, "FTH-PT1-1731C-W-H-OT1040-PR")) {
				if (tg.performAssert(var_Process_Employee_ID, ComparisonType.EQUAL_TO, "13294947")) {
